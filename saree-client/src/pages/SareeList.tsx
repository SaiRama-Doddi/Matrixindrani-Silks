...
export function Sarees() {
  ...
  return (
    ...
    <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white rounded-xl my-8">
      <div className="top-10 bg-white border-b border-gray-200 px-6 py-4 rounded-t-xl">
